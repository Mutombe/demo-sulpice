...
function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      {/* Slide indicators -- right edge (thin gold bars) */}
      ...
      >
        ...
        <div className="overflow-hidden">
          {['WHERE EVERY', 'MOMENT', 'BECOMES A MASTERPIECE.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
            ...
            >
              <h1
                ...
                style={{
                  ...
                  fontWeight: line === 'MOMENT' ? 700 : 300,
                }}
              >
                {line}
              </h1>
        ...
        >
          ...
          <p className="text-white/30 text-xs sm:text-sm uppercase tracking-[0.2em]" style={{ fontFamily: 'var(--font-sans)' }}>
            500+ Events &middot; 3 Countries &middot; Est. 2016
          </p>
        </motion.div>
      ...
      <div className="hidden lg:flex absolute right-8 bottom-12 z-20">
        ...
        >
          Sulpice &mdash; Harare &middot; Bulawayo &middot; Johannesburg
        </span>
      </div>
    </section>
  );
...
function MarqueeTicker() {
  const items = ['WEDDINGS', 'CORPORATE GALAS', 'BIRTHDAYS', 'CONFERENCES', 'FLORAL DESIGN', 'CUSTOM INSTALLATIONS'];
          ...
          {projects.items.map((project, i) => (
            ...
            >
              <div className="aspect-[3/4] overflow-hidden relative">
                ...
                <div className="absolute inset-0 border-2 border-transparent group-hover:border-[#00BCD4]/40 transition-colors duration-500 z-10" />
...
function StatsBand() {
  ...
  return (
    <section ref={ref} className="relative bg-navy-950 overflow-hidden">
      {/* Gold glow gradients behind numbers */}
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-white/50 text-sm sm:text-base leading-relaxed mb-6 max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
              Founded in 2016 with a singular belief: that every gathering, no matter the scale, deserves to be wrapped in beauty. What began as a small floral design studio in Eastlea, Harare, has grown into one of Southern Africa's most sought-after event design companies.
            </p>
            <p className="text-white/35 text-sm leading-relaxed max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
              Today, with branches in Harare, Bulawayo, and Johannesburg, we bring the same obsessive attention to detail and creative ambition to every project. Over 500 events, from intimate garden weddings to 1,000-guest corporate galas.
            </p>
            ...
            <div className="flex gap-10 sm:gap-16">
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl italic leading-none">2016</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Founded</div>
              </div>
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl italic leading-none">500+</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Events</div>
              </div>
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl italic leading-none">3</div>
...
function WhyChooseUs() {
  ...
  const points = [
    { title: 'Award-Winning Design', desc: 'Recognized across Southern Africa for creative excellence and innovation in event styling.' },
    { title: 'Multi-Country Reach', desc: 'Same world-class standard across our Harare, Bulawayo, and Johannesburg studios.' },
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-gold-500">Sulpice</span>
            </h2>
...
/* ================================================================
   8. LOCATIONS STRIP — 3-city showcase
   ================================================================ */
function LocationsStrip() {
  ...
  return (
    <section ref={ref} className="bg-navy-950 py-24 sm:py-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        {/* Header */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
        ...
        >
          ...
          <h2 className="font-heading text-white leading-[0.95] italic" style={{ fontSize: 'clamp(2rem, 4.5vw, 3.5rem)' }}>
            Three Cities, <span className="text-gold-500">One Standard</span>
          </h2>
        </motion.div>

        {/* City cards with connecting lines */}
        <div className="relative grid md:grid-cols-3 gap-6 sm:gap-8">
          {/* Gold connecting line -- desktop */}
          <div className="hidden md:block absolute top-1/2 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-gold-500/20 to-transparent z-0" />
          ...
          {cities.map((city, i) => (
            ...
            >
              {/* Image circle */}
              <div className="w-36 h-36 sm:w-44 sm:h-44 mx-auto mb-6 rounded-full overflow-hidden border-2 border-gold-500/20 group-hover:border-gold-500/50 transition-colors duration-500">
                <img
                  src={city.image}
                  alt={`Sulpice ${city.name}`}
                  className="w-full h-full object-cover object-center transition-transform duration-700 group-hover:scale-110"
                  loading="lazy"
                />
              </div>
              <h3 className="font-heading text-white text-2xl italic mb-1">{city.name}</h3>
              <p className="text-white/30 text-xs uppercase tracking-[0.2em] mb-5" style={{ fontFamily: 'var(--font-sans)' }}>{city.subtitle}</p>
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 border border-gold-500/30 text-gold-500 px-5 py-2.5 text-xs uppercase tracking-[0.15em] font-semibold hover:bg-gold-500/10 hover:border-gold-500/50 transition-all duration-300"
                style={{ fontFamily: 'var(--font-sans)' }}
              >
                Book Here
                <ArrowRight size={12} />
...
/* ================================================================
   9. TESTIMONIALS — Dark bg, gold quote marks, auto-cycling
   ================================================================ */
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <blockquote
                className="text-white text-lg sm:text-xl lg:text-2xl leading-relaxed font-heading italic mb-10"
              >
                &ldquo;{t.text}&rdquo;
              </blockquote>
...
/* ================================================================
   10. SOCIAL / INSTAGRAM FEED — Horizontal strip
   ================================================================ */
function SocialFeed() {
  const ref = useRef(null);
  ...
  return (
    <section ref={ref} className="bg-navy-900 py-16 sm:py-20 overflow-hidden">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={inView ? { opacity: 1, y: 0 } : {}}
      ...
      >
        <p className="text-white/30 text-xs uppercase tracking-[0.3em] mb-2" style={{ fontFamily: 'var(--font-sans)' }}>
          Follow Our Journey
        </p>
        <a
          href="https://www.instagram.com/sulpicedesigns"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 text-gold-500 font-heading text-lg sm:text-xl italic hover:text-gold-400 transition-colors"
        >
      ...
      <div className="flex gap-2 sm:gap-3 overflow-hidden">
        {feedImages.map((img, i) => (
          <motion.a
            ...
            className="flex-1 min-w-0 aspect-square overflow-hidden group relative"
          >
            <img
              src={img}
            ...
            <div className="absolute inset-0 bg-navy-950/0 group-hover:bg-navy-950/40 transition-colors duration-300 flex items-center justify-center">
              <InstagramLogo size={24} className="text-white opacity-0 group-hover:opacity-80 transition-opacity duration-300" />
            </div>
          </motion.a>
        ))}
      </div>
...
/* ================================================================
   11. CTA SECTION — Cinematic full-bleed
   ================================================================ */
function CTASection() {
    ...
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
        ...
        >
          ...
          >
            YOUR VISION<br />
            <span className="text-gold-500">OUR ARTISTRY</span>
          </h2>
          ...
          <div className="mt-16 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-center gap-6 text-xs text-white/25 uppercase tracking-[0.15em]" style={{ fontFamily: 'var(--font-sans)' }}>
            ...
            <span className="flex items-center gap-2">
              <MapPin size={14} /> Harare &middot; Bulawayo &middot; Johannesburg
            </span>
          </div>
        </motion.div>
      </div>
